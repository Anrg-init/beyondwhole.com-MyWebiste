// src/features/messagetogod/PublicFeed.jsx
  ...
  return (
    <div style={{ fontFamily: "Manifold, system-ui, sans-serif", color: "#383B39" }}>
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-sm" style={{ color: "rgba(56,59,57,0.8)", fontFamily: "Manifold, system-ui" }}>{count} messages</div>
      </div>
      ...
      {count === 0 ? (
        ...
        >
          <div className="mb-2 font-medium" style={{ color: "#383B39", fontFamily: "Manifold, system-ui" }}>No public messages in this view.</div>
